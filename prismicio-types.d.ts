...
/**
 * Item in *Hero Banner → Default → Primary → Call to Actions*
 */
export interface HeroBannerSliceDefaultPrimaryCtasItem {
  /**
   * Button Label field in *Hero Banner → Default → Primary → Call to Actions*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.default.primary.ctas[].cta_label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  cta_label: prismic.KeyTextField;

  /**
   * Button Link field in *Hero Banner → Default → Primary → Call to Actions*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.default.primary.ctas[].cta_link
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  cta_link: prismic.LinkField<
    string,
  ...
  /**
   * Is Primary Button? field in *Hero Banner → Default → Primary → Call to Actions*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.default.primary.ctas[].cta_primary
   * - **Documentation**: https://prismic.io/docs/fields/boolean
   */
  cta_primary: prismic.BooleanField;
}
...
export interface HeroBannerSliceDefaultPrimary {
  /**
   * Badge Label field in *Hero Banner → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.default.primary.badge_label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  badge_label: prismic.KeyTextField;

  /**
   * Badge Subtext field in *Hero Banner → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.default.primary.badge_subtext
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  badge_subtext: prismic.KeyTextField;

  /**
   * Main Heading field in *Hero Banner → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Description field in *Hero Banner → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Call to Actions field in *Hero Banner → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.default.primary.ctas[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  ctas: prismic.GroupField<Simplify<HeroBannerSliceDefaultPrimaryCtasItem>>;

  /**
   * Dashboard Screenshot field in *Hero Banner → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.default.primary.dashboard_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
 ...
 *
 * - **API ID**: `default`
 * - **Description**: Standard hero banner layout.
 * - **Documentation**: https://prismic.io/docs/slices
 */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      HeroBannerSlice,
      HeroBannerSliceDefaultPrimaryCtasItem,
